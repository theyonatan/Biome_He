    ...
    app: {
      ...
      settings: {
        ...
        gooseMode: {
          label: '鹅模式',
          facts: [
            '鹅可以让一半大脑保持清醒来警惕危险，同时另一半大脑睡觉。',
            '顺风条件下，迁徙的鹅一天可以飞行超过 2,400 公里。',
            '鹅的家庭关系非常紧密：父母双方会在头几周共同守护雏鹅。',
            '加拿大鹅能发出数十种不同的叫声来指示方向、示警和集合。',
            'V 字队形飞行可以利用前方翼尖涡流的升力来节省体力。',
            '许多鹅年复一年地返回同一个筑巢地。',
            '当一只鹅受伤时，其他鹅可能会留在它身边而不是离开。',
            '鹅的羽毛天然防水，保暖效果极佳。',
            '雏鹅在孵化后一天内就能游泳，通常由父母紧密护送。',
            '有些鹅种在穿越山脉时能在非常高的海拔飞行。',
            '加拿大鹅的数量在 1900 年代初的大幅下降后，通过保护和狩猎法规得以恢复。',
            '直到 2004 年鸟类学家将小加拿大鹅（Cackling Goose）从加拿大鹅中独立为单独物种。',
            '加拿大鹅有七个公认的亚种，包括体型很大的巨型加拿大鹅。',
            '巨型加拿大鹅曾被认为已经灭绝，直到 1962 年在明尼苏达州重新发现了一小群。',
            '加拿大鹅倾向于选择体型相近的伴侣，通常终身配对。',
            '成年加拿大鹅通常要到至少两岁才会结成繁殖对。',
            '较大的雏鹅有时会组成由成鹅看护的混合群体，称为"帮派育雏"。',
            '防御中的加拿大鹅可能会嘶叫、展翅、点头、冲锋，甚至飞向威胁者。',
            '加拿大鹅大量在陆地上觅食，尤其是草、莎草、种子和浆果。',
            '鹅吃水生植物，有时也吃软体动物或甲壳类等小型水生动物。',
            '迁徙的鹅经常在农田中停歇，取食种植的谷物。',
            '当 V 字队形中领头的鸟疲劳时，它会退到后面，由另一只鸟接替领飞。',
            '如今美国本土 48 州的许多加拿大鹅已成为常年留鸟，不再长途迁徙。',
            '北方的加拿大鹅仍然进行曾经更为普遍的长途迁徙。',
            '一只加拿大鹅身上大约有 20,000 到 25,000 根羽毛。',
            '鹅羽毛中大部分是保暖绒毛，帮助它们应对冰冷的水和寒冷的天气。',
            '加拿大鹅通过换羽更换所有羽毛，夏末时飞羽会一次性全部脱落。',
            '在换羽期间，鹅可能会被困在地面数周，直到新的飞羽长出。',
            '幼鹅会对出生后遇到的第一个合适的移动对象产生印记，并可能长期依附于它。',
            '鹅是高度社会化的动物，在与其他动物一起长大时往往能融洽相处。',
            '母鹅叫 goose，公鹅叫 gander，飞行中的鹅群常被称为 skein。',
            '尽管是水禽，鹅大部分时间都在陆地上度过。',
            '鹅在失去伴侣或一窝蛋之后可能会表现出类似悲伤的行为。',
            '它们经常花时间梳理羽毛、觅食和收集植物材料来改善巢穴。',
            '鹅会形成牢固的社会纽带，对群体中的其他成员表现出明显的亲近感。'
          ]
        },
        credits: {
          title: '鸣谢'
