...
// https://www.four-paws.org/campaigns-topics/topics/farm-animals/10-facts-about-geese
const GOOSE_FACTS = [
...
export const GooseModeCheckbox = ({ checked, onChange }: GooseModeCheckboxProps) => {
  ...
  return (
    <div className="flex items-center gap-[2cqh]">
      <span className={`${SETTINGS_LABEL_BASE} text-text-primary w-[25cqh] text-right shrink-0`}>Goose Mode</span>
      <button
        type="button"
